...
import ReceiveIt from './ReceiveIt.jsx';
...
export default function App() {
  ...
  const handleSelect = (label) => {
    ...
    else if (label === 'ReceiveIT') setView('receive-it');
    // TagIT, Settings and Log Out have no screen in this prototype yet —
