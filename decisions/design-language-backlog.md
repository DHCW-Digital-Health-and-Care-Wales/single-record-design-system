...
| DL-014 | Button component **description** in Figma still says "Type: Primary · Secondary · Ghost · **Warning**" | Button `1346:500` | The variants were renamed Warning → Destructive on 2026-06-24 but the component description was never updated. Surfaces in Code Connect output and dev handoff. Description also still lists "Pending semantic tokens: Interactive/Primary Disabled, Interactive/Destructive Hover" — confirm whether those are still pending. |
