...
//   two cannot drift.
//
// Every icon is a 24x24 viewBox, stroke-width 2, round caps and joins. Consumers
...
lines.push('');
lines.push(`    ${icons.length} icons, each a 24x24 geometry drawn with stroke-width 2 and`);
...
lines.push('              StrokeThickness="2" StrokeLineCap="Round" StrokeLineJoin="Round"');
